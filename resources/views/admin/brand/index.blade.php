...
@section('admin')
    <div class="py-12">
      ...
      <tbody>
         ...
         <tr>
            ...
            <td><img src ="{{ asset($brand->brand_image)}}" style="heigh:60px; width:90px;"></td>
            <td>
    ...
    <div class ="card-body">
      ...
      <div class="form-group">
        ...
        <input type="file" name="brand_image" class="form-control" id="exampleInputEmail1"  placeholder="Enter Brand Image">
